...
const dotenvxconfig = require("./dotenvXconfig.js");
...
module.exports = {
  client,
  conectionAzureCosmosDB: (containerName) =>
    client.database(dotenvxconfig.COSMOSDB_DATABASE).container(containerName),
};
